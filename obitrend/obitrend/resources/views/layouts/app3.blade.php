...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Metronic Admin Theme #2 | Pricing Tables</title>
        <meta http-equiv="X-UA-Compatible" content="IE=edge">
        <meta content="width=device-width, initial-scale=1" name="viewport" />
        <meta content="Preview page of Metronic Admin Theme #2 for pricing table samples" name="description" />
        ...
        <link href="{{asset('layout_assets/pages/css/pricing.min.css')}}" rel="stylesheet" type="text/css" />
