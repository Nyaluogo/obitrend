...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Obitrend | User Login </title>
    ...
    <body class=" login">
          ...
          <form class="register-form" action="{{ route('register') }}" method="POST">
             ...
             {{ csrf_field() }}
                ...
                <div class="form-group{{ $errors->has('first_name') ? ' has-error' : '' }}">
                    ...
                    <input class="form-control placeholder-no-fix" type="text" placeholder="First Name" id="first_name" value="{{ old('first_name') }}" name="first_name" />
        ...
        <div class="copyright"> 2017 © Obitrend international. </div>
        <!--[if lt IE 9]>
