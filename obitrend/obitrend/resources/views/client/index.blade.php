                    ...
                    <div class="portlet light " id="form_wizard_1">
                        <div class="portlet-title">
                            <div class="caption">
                                ...
                                <span class="caption-subject font-red bold uppercase"> Make announcement-
                        ...
                        <div class="portlet-body form">
                              <form class="form-horizontal" action="/announcements" id="submit_form" method="POST">
  {{ csrf_field() }}
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                        <select name="type_of_announcement" id="country_list" class="form-control">
                                                            ...
                                                            <option value="AL">Missing persons</option>
                                                            <option value="DZ">Public notice</option>
                                            ...
                                            <div class="tab-pane" id="tab2">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-md-4">
                                                          ...
                                                          <input type="file" name="file_path" id="exampleInputFile1">
